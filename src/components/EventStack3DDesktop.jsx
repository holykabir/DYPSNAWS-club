    ...
    >
      <RoundedBox args={[5.5, 2.2, 0.06]} radius={0.08} smoothness={4}>
        <meshStandardMaterial
          color={hovered ? (event.color || "#A855F7") : "#1a0533"}
          transparent
      ...
      <Html position={[2.3, 0.82, 0.05]} center>
        <span
          style={{
            ...
            whiteSpace: "nowrap",
            pointerEvents: "none",
            color: event.status === "Completed" ? "#22c55e" : event.status === "Ongoing" ? "#f59e0b" : "#3b82f6",
            background: event.status === "Completed" ? "rgba(34,197,94,0.15)" : event.status === "Ongoing" ? "rgba(245,158,11,0.15)" : "rgba(59,130,246,0.15)",
            border: `1px solid ${event.status === "Completed" ? "rgba(34,197,94,0.3)" : event.status === "Ongoing" ? "rgba(245,158,11,0.3)" : "rgba(59,130,246,0.3)"}`,
          }}
        >
      ...
      {hovered && (
        <Html position={[1.8, -0.6, 0.08]} center>
          <button
            ...
            style={{
              background: event.color || "#A855F7",
              fontFamily: "var(--font-display)",
              boxShadow: `0 0 20px ${event.color || "#A855F7"}60`,
              pointerEvents: "auto",
            }}
          >
            VIEW EVENT →
